...
const MemberList = createVisualComponent({
  ...
  render({ loggedUser, isOwner, shoppingListDetail, handleUpdate }) {
    ...
    return (
      ...
      <Block card={"full"} header={<Lsi lsi={{ cs: "Seznam členů", en: "Member List"}}/>} headerType={"title"} headerSeparator>
        <Grid rowGap={"10px"}>
          <div style={{ display: "flex", alignItems: "center" }}>
            <User img={owner.img} name={owner.name} />
            <div style={{ fontStyle: "italic", color: "grey", marginLeft: "8px" }}><Lsi lsi={{ cs: "majitel", en: "owner"}}/></div>
          ...
          {isEditable && (
            <>
              ...
              <TextSelect
                label={<Lsi lsi={{ cs: "Přidat člena", en: "Add a Member"}}/>}
